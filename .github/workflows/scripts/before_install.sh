...
git clone --depth=1 https://github.com/pulp/pulp_container.git --branch 2.7
...
git clone --depth=1 https://github.com/pulp/pulp_rpm.git --branch 3.13
...
git clone --depth=1 https://github.com/pulp/pulp_deb.git --branch 2.13
