...
git clone --depth=1 https://github.com/pulp/pulp_container.git --branch 2.9
cd pulp_container
...
git clone --depth=1 https://github.com/pulp/pulp_rpm.git --branch 3.16
cd pulp_rpm
...
git clone --depth=1 https://github.com/pulp/pulp_deb.git --branch 2.16
cd pulp_deb
