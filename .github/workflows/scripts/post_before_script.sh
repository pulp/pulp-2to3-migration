...
#EOF"
#
#cmd_prefix bash -c "dnf install -y mongodb-org-tools"
cat pulp_2to3_migration/tests/functional/scripts/set_pulp2_fs.sh | cmd_stdin_prefix bash -c "cat > /tmp/set_pulp2_fs.sh"
cmd_prefix bash -c "chmod 755 /tmp/set_pulp2_fs.sh"
