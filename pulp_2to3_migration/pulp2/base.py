...
class Repository(Document):
    ...
    meta = {"collection": "repos", "allow_inheritance": False}
...
class RepositoryContentUnit(Document):
    ...
    meta = {"collection": "repo_content_units", "allow_inheritance": False}
...
class Distributor(Document):
    ...
    meta = {"collection": "repo_distributors", "allow_inheritance": False}
