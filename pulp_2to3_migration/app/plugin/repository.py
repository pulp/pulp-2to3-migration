...
class Pulp2to3Distributor:
    ...
    @classmethod
    async def migrate_to_pulp3(cls, pulp2distributor, repo_version=None):
        """
        ...
        Return:
            ...
            created(bool): True if distribution has just been created; False if distribution is an existing one
