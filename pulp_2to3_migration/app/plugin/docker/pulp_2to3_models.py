...
class Pulp2Blob(Pulp2to3Content):
    ...
    def pre_migrate_content_detail(cls, content_batch):
        ...
        cls.objects.bulk_create(
            pulp2blob_to_save, ignore_conflicts=True, batch_size=DEFAULT_BATCH_SIZE
        )
...
class Pulp2Manifest(Pulp2to3Content):
    ...
    def pre_migrate_content_detail(cls, content_batch):
        ...
        cls.objects.bulk_create(
            pulp2m_to_save, ignore_conflicts=True, batch_size=DEFAULT_BATCH_SIZE
        )
...
class Pulp2Tag(Pulp2to3Content):
    ...
    def pre_migrate_content_detail(cls, content_batch):
        ...
        cls.objects.bulk_create(
            pulp2tag_to_save, ignore_conflicts=True, batch_size=DEFAULT_BATCH_SIZE
        )
