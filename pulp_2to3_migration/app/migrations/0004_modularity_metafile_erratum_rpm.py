    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="yum_repo_metadata_file_detail_model",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repodata",
                    django.contrib.postgres.fields.jsonb.JSONField(verbose_name=dict),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="modulemd_defaults_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="modulemd_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="erratum_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
