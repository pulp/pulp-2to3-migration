...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "unique_together": {
                    ("pulp2_storage_path", "pulp2_importer_id", "pulp2_revision")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        to="pulp_2to3_migration.Pulp2Repository",
                    ),
                ),
                (
                    "pulp3_remote",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="docker_tag_detail_model",
            ...
            options={
                ...
                "unique_together": {
                    ("name", "tagged_manifest", "repo_id", "pulp2content")
                },
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="docker_manifest_list_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="docker_manifest_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="docker_blob_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
