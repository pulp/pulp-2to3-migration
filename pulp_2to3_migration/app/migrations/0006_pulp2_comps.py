            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="package_langpacks_detail_model",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="package_group_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="package_environment_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
            options={
                ...
                "unique_together": {
                    ("repo_id", "package_environment_id", "pulp2content")
                },
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="package_category_detail_model",
                        to="pulp_2to3_migration.Pulp2Content",
                    ),
                ),
            ],
