...
if [ "$TEST" = 'bindings' ]; then
  ...
  ./generate.sh pulp_2to3_migration ruby
...
$CMD_PREFIX bash -c "PULP_SETTINGS=/unit-test.py django-admin test  --noinput /usr/local/lib/python${TRAVIS_PYTHON_VERSION}/site-packages/pulp_2to3_migration/tests/unit/"
